...
OnlineLoader = require 'util.OnlineLoaderUnk'
...
opt.tokens = {}
opt.tokens.BOS = '__BOS__' --opt.BOS
opt.tokens.EOS = '__EOS__' --opt.EOS
opt.tokens.UNK = '_UNKWN_' -- '|' -- unk word token
opt.tokens.START = '__BOW__' -- '{' -- start-of-word token
opt.tokens.END = '__EOW__' -- '}' -- end-of-word token
...
loader = OnlineLoader.create(opt.data_dir, opt.batch_size, opt.seq_length, opt.max_word_l)
...
print ('#loader.idx2word: ' .. #loader.idx2word)
print ('opt.word_vec_size: ' .. opt.word_vec_size)
print ('#loader.idx2char: ' .. #loader.idx2char)
print ('opt.char_vec_size: ' .. opt.char_vec_size)
print ('opt.char_vec_size: ' .. opt.char_vec_size)
--print ('opt.kernels: ' .. opt.kernels)
print ('loader.max_word_l: ' .. loader.max_word_l)
print ('opt.use_words: ' .. opt.use_words)
print ('opt.use_chars: ' .. opt.use_chars)
print ('opt.batch_norm: ' .. opt.batch_norm)
